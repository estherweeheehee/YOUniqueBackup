                    ...
                    <div className="flex space-x-4 sm:min-w-0 sm:flex-1 sm:space-x-6 lg:space-x-8">
                      ...
                      <div className="pt-1.5 min-w-0 flex-1 sm:pt-0">
                        ...
                        <p className="text-sm text-gray-500 truncate">
                          ...
                          <span>Quantity per month: {qty}</span>
                        </p>
                        <p className="text-sm text-gray-500 truncate">

                          <span>Subscribed since {moment(subscriptionDate).format('DD MMMM YYYY')}</span>
                          
                        </p>
                        <p className="text-sm text-gray-500 truncate">

                          <span>Buyer: {buyerUsername}</span>
                        </p>
                        <p className="mt-1 font-medium text-gray-900">Price per month: ${price.toLocaleString()}</p>
                      </div>
                    </div>
